...
function WareHouseManagerDashbord() {
    ...
    <div className="dashboard">
        <div className="grid">
            <div className="tile">
                ...
                <h4>{dashboard.noOfSuppliers}</h4>
                <button className='btn btn-dark' onClick={goToSupplier}>View Suppliers</button>
            </div>
            <div className="tile">
            ...
            <div className="tile">
                <h4>Products Imported Worth Rs</h4>
                <h4>{dashboard.totalSumOfOrders}</h4>
                <button className='btn btn-dark' onClick={goToOrders}>View Orders</button>
            </div>
        </div>
    </div>
    </AdminSidebar>
...
export default WareHouseManagerDashbord
